(function ($, root, undefined) {
	...
	$(function () {
		...
		/**
		 * Inicializamos el slider cuando hacemos resize del navegador.
		 */
		...
		$('.js-slideDemo').each(function (index, sliderWrap) {
		 ...
		 * Inicializamos el slider cuando hacemos resize del navegador.
		 */
		$('.js-slideDemo .__loop').on('init', function(event, slick){
			$(window).resize(function(){
				$('.js-slideDemo .__loop')[0].slick.refresh();
			});
		});
		...
		/**
		* Añadimos los botones al menu mobile
		*/
		$('.m-navHeaderMob .menu-item-has-children').prepend('<button aria-label="Open submenu"><svg xmlns="http://www.w3.org/2000/svg" class="u-color-one" width="16.454" height="10.089" viewBox="0 0 16.454 10.089"><path d="M15,0,7.5,7.946,0,0" transform="translate(0.727 0.686)" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="2"/></svg></button>');
